...
fun rememberNavigationState(
    ...
    val topLevelStack = rememberNavBackStack(PhovoNavSavedStateConfiguration,startKey)
    val subStacks = topLevelKeys.associateWith { key -> rememberNavBackStack(PhovoNavSavedStateConfiguration,key) }
